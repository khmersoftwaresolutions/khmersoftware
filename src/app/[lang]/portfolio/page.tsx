...
const PROJECTS = [
  { title: 'NagaWorld Digital Wallet', industry: 'Finance', type: 'Web App', color: COLORS.cyan, emoji: '💳', desc: 'A full-featured digital wallet platform with KYC verification, QR payments, and real-time transaction analytics for 50,000+ users.', tech: ['React', 'Node.js', 'PostgreSQL', 'AWS'], results: ['50K+ users', '99.99% uptime', '<200ms API'] },
  { title: 'MekongPharma ERP', industry: 'Healthcare', type: 'Web App', color: COLORS.green, emoji: '🏥', desc: 'End-to-end ERP system covering inventory, patient prescriptions, billing, and supplier management for a 12-branch pharmacy chain.', tech: ['Next.js', 'Python', 'MongoDB', 'Docker'], results: ['12 branches', '40% cost saving', 'Real-time sync'] },
  { title: 'AgroCambodia Marketplace', industry: 'E-Commerce', type: 'Web App', color: COLORS.yellow, emoji: '🌾', desc: 'B2B agricultural marketplace connecting 3,000+ farmers directly with buyers, featuring live price feeds and logistics tracking.', tech: ['Vue.js', 'Node.js', 'MySQL', 'Redis'], results: ['3K+ farmers', '$2M GMV/mo', 'Mobile-first'] },
  { title: 'PhnomPenh City App', industry: 'Government', type: 'Mobile', color: COLORS.blue, emoji: '🏛️', desc: 'A citizen services mobile app for Phnom Penh Municipality — report issues, pay fees, access permits, and track public transport.', tech: ['React Native', 'Go', 'PostgreSQL', 'AWS'], results: ['200K downloads', '4.7★ rating', 'Khmer & English'] },
  { title: 'SiemReap Hotel Suite', industry: 'E-Commerce', type: 'Web App', color: COLORS.cyan, emoji: '✈️', desc: 'Property management system + online booking engine for a 5-star resort group, integrated with Agoda, Booking.com, and AirBnB.', tech: ['Next.js', 'Node.js', 'PostgreSQL', 'Stripe'], results: ['30% booking uplift', 'OTA sync', 'Revenue analytics'] },
  { title: 'ACLEDA Mobile Banking', industry: 'Finance', type: 'Mobile', color: COLORS.green, emoji: '🏦', desc: 'Rebuilt mobile banking application with biometric login, P2P transfers, bill payment, and NBC-compliant KYC flows.', tech: ['Flutter', 'Java', 'Oracle DB', 'AWS'], results: ['500K+ installs', 'Biometric auth', 'NBC compliant'] },
  { title: 'KhmerLearn LMS', industry: 'Healthcare', type: 'Web App', color: COLORS.yellow, emoji: '🎓', desc: 'A bilingual (Khmer/English) learning management system for 20 universities across Cambodia, with video streaming and assessments.', tech: ['React', 'Django', 'PostgreSQL', 'CloudFront'], results: ['20 universities', '100K students', '4K+ courses'] },
  { title: 'CambodiaPost Tracker', industry: 'Government', type: 'Mobile', color: COLORS.blue, emoji: '📦', desc: 'National parcel tracking app with real-time GPS updates, automated SMS notifications, and a public API for e-commerce integration.', tech: ['React Native', 'Node.js', 'MongoDB', 'GCP'], results: ['1M+ parcels/mo', 'Real-time GPS', 'Public API'] },
  { title: 'Sorya Mall POS', industry: 'E-Commerce', type: 'Web App', color: COLORS.cyan, emoji: '🏪', desc: 'Cloud POS system with loyalty rewards, inventory sync, sales analytics, and franchise management for 50+ retail outlets.', tech: ['React', 'Node.js', 'MySQL', 'Redis'], results: ['50+ outlets', 'Offline mode', 'Real-time reports'] },
];
            ...
            {filtered.map((p, i) => (
              <ScrollReveal key={p.title} delay={i * 60} direction="up">
                <div className="port-card">
                  {/* Banner */}
                  <div style={{ height: 160, background: `linear-gradient(135deg, ${p.color}20, ${p.color}08)`, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', borderBottom: `1px solid ${p.color}15` }}>
                    <div style={{ fontSize: 72 }}>{p.emoji}</div>
                    <div style={{ position: 'absolute', top: 16, left: 16, fontSize: 11, fontWeight: 700, padding: '4px 10px', borderRadius: 100, background: `${p.color}15`, color: p.color }}>{p.industry}</div>
                    <div style={{ position: 'absolute', top: 16, right: 16, fontSize: 11, fontWeight: 600, padding: '4px 10px', borderRadius: 100, background: 'rgba(5,5,69,0.06)', color: 'rgba(5,5,69,0.5)' }}>{p.type}</div>
                  </div>
                  {/* Content */}
